...
while cap.isOpened():
    ...
    if success:
        ...
        results = model.predict(frame, stream=True, device='mps', verbose=False, vid_stride=5, conf=0.4)
        ...
        cv2.putText(frame, fps, (5, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (100, 255, 0), 2, cv2.LINE_AA)
